    ...
    (() => {
        ...
        function formFieldsInit() {
            ...
            document.body.addEventListener("click", (function(e) {
                ...
                if ("checkbox" === targetElement.type && true === targetElement.checked && targetElement.classList.contains("_error") && targetElement.parentElement.classList.contains("_error")) {
            ...
            document.body.addEventListener("focusin", (function(e) {
                ...
                if ("INPUT" === targetElement.tagName || "TEXTAREA" === targetElement.tagName) {
                    ...
                    if ("phone" === targetElement.dataset.mask && !targetElement.classList.contains("main-intro__input_phone") && !targetElement.classList.contains("main-intro__input_promocode")) {
                    ...
                    if (targetElement.classList.contains("main-intro__input_phone")) {
                        targetElement.classList.add("_mask");
                    ...
                    if ("date" === targetElement.dataset.mask) {
                        ...
                        targetElement.addEventListener("input", (function() {
                            ...
                            if (targetElement.value[1] > 1 && 3 == targetElement.value[0]) {
                            ...
                            if (targetElement.value[4] > 2 && 1 == targetElement.value[3]) {
                            ...
                            if (targetElement.value[6] > 2 || targetElement.value[6] < 2) {
                                const value = targetElement.value.slice(0, -4);
                                targetElement.value = `${value}2`;
                            }
                            if (targetElement.value[7] >= 1) {
                                const value = targetElement.value.slice(0, -3);
                                targetElement.value = `${value}0`;
                            }
                        }));
                    }
                    if ("time" === targetElement.dataset.mask) {
                        targetElement.classList.add("_mask");
                        Inputmask("99:99", {
                            clearIncomplete: false,
                            clearMaskOnLostFocus: true
                        ...
                        targetElement.addEventListener("input", (function() {
                            ...
                            if (targetElement.value[1] > 3 && 2 == targetElement.value[0]) targetElement.value = "23:__";
                ...
                if ("INPUT" === targetElement.tagName || "TEXTAREA" === targetElement.tagName) {
                    ...
                    if (targetElement.dataset.labelInput = " ") {
                        if ("" === targetElement.value) {
                            if ("phone" != targetElement.dataset.mask && "date" != targetElement.dataset.mask && "time" != targetElement.dataset.mask) {
                                targetElement.classList.remove("_focus");
                                targetElement.parentElement.classList.remove("_focus");
                            }
                            if ("" === targetElement.value && "phone" === targetElement.dataset.mask) {
                            ...
                            if ("" === targetElement.value && "date" === targetElement.dataset.mask) {
                                targetElement.placeholder = targetElement.dataset.placeholder;
                                targetElement.inputmask.remove();
                                targetElement.classList.remove("_mask");
                                targetElement.classList.remove("_focus");
                            ...
                            if ("" === targetElement.value && "time" === targetElement.dataset.mask) {
                                targetElement.placeholder = targetElement.dataset.placeholder;
                                targetElement.inputmask.remove();
                                targetElement.classList.remove("_mask");
                                targetElement.classList.remove("_focus");
        ...
        let formValidate = {
            getErrors(form) {
                ...
                if (formRequiredItems.length) formRequiredItems.forEach((formRequiredItem => {
                    if (null !== formRequiredItem.offsetParent) error += this.validateInput(formRequiredItem);
                }));
                return error;
            },
            validateInput(formRequiredItem) {
                let error = 0;
                if ("email" === formRequiredItem.dataset.mask) {
                    ...
                    this.addError(formRequiredItem);
                    error++;
                } else if ("phone" == formRequiredItem.dataset.mask) if (!formRequiredItem.value || -1 != formRequiredItem.value.indexOf("_")) {
                    this.addError(formRequiredItem);
                    error++;
                } else this.removeError(formRequiredItem); else if ("date" == formRequiredItem.dataset.mask) if (!formRequiredItem.value || -1 != formRequiredItem.value.indexOf("_")) {
                    this.addError(formRequiredItem);
                    error++;
                } else this.removeError(formRequiredItem); else if ("time" == formRequiredItem.dataset.mask) if (!formRequiredItem.value || -1 != formRequiredItem.value.indexOf("_")) {
                    this.addError(formRequiredItem);
                    error++;
            ...
            formClean(form) {
                ...
                inputs.forEach((inputItem => {
                    ...
                    if ("phone" === inputItem.dataset.mask) if (inputItem.classList.contains("_mask")) {
                        inputItem.inputmask.remove();
                        inputItem.classList.remove("_mask");
                    }
                    if ("date" === inputItem.dataset.mask) if (inputItem.classList.contains("_mask")) {
                        inputItem.inputmask.remove();
                        inputItem.classList.remove("_mask");
                    }
                    if ("time" === inputItem.dataset.mask) if (inputItem.classList.contains("_mask")) {
                        inputItem.inputmask.remove();
                        inputItem.classList.remove("_mask");
                    }
                }));
        ...
        function checkbox_checkbox() {
            const checkboxParent = document.querySelectorAll("[data-checkbox]");
            if (checkboxParent.length) checkboxParent.forEach((formCheckbox => {
                const checbox = formCheckbox.querySelectorAll('input[type="checkbox"]');
                if (checbox.length) for (let i = 0; i < checbox.length; i++) {
                    const checkboxItem = checbox[i];
...
$( document ).ready(function() {
    $(".main-intro__check .checkbox-main-intro__input").click(function() {
        if($(this).is(":checked")) {
            $(".main-intro__accordion.cash").hide(200);
            $(".main-intro__accordion.installment").hide(200);
        } else {
            $(".main-intro__accordion.cash").show(300);
            $(".main-intro__accordion.installment").show(300);
        }
    });
